...
class DevisController extends BaseController
{
    ...
    public function Index()
    {
        ...
        echo '<script src="' . AppConfig::getConst('BASE_URL_PUBLIC_ASSETS_JS') . 'filesize.js"></script>';
    ...
    public function mailSendWithFile()
    {
        ...
        $dotenv = Dotenv::createImmutable(AppConfig::getConst('BASE_PATH'));
        $dotenv->load();
        ...
        if (isset($_FILES['fichier'])) {
            ...
            $fichier_size_show = $this->show_filesize($fichier_tmp);
            ...
            if ($_FILES["fichier"]["error"] == 0 && $fichier_type == "application/pdf" && $fichier_size < $this->maxsize) {
                ...
                $headers = "From: " . AppConfig::getEnv('MAIL_FROM_ADDRESS') . "\r\n";
                $headers .= "Reply-To: " . AppConfig::getEnv('MAIL_FROM_ADDRESS') . "\r\n";
                ...
                switch (AppConfig::getEnv('MAIL_ENCRYPTION')) {
                    case 'STARTTLS':
                ...
                $mail->Username = AppConfig::getEnv('MAIL_FROM_ADDRESS');
                ...
                $mail->setFrom(AppConfig::getEnv('MAIL_FROM_ADDRESS'), 'Service client');
                ...
                $mail->addAddress(AppConfig::getEnv('MAIL_FROM_ADDRESS'), 'Service client');
