...
class RouteCompiler
{
    ...
    public static function compile(): array
    {
        ...
        try {
            ...
            foreach (self::getControllersPath() as $controllerPath) {
                ...
                // Ex: 'App\\...Controller <= '*/Interface/Http/Controllers/*.php'
                ...
                foreach (self::getRoutesFromClass($class) as $method => $methodRoutes) {
                     ...
                     *      [GET] => Array
                     *              [0] => Array
                     *                  [class] => App\Modules\Home\Interface\Http\Controllers\HomeIndexController
    ...
    // Return:
    // ['/var/www/...App/Modules/Products/....DetailController.php',
    // '/var/www/...App/Modules/Products/....ListController.php',
    // '/var/www/...App/Modules/Users/....Controller.php', ...]
    private static function getControllersPath(): array
    {
        $basePath = AppConfig::getConst('LOCAL_PATH_APP_MODULES');
    ...
    // from /var/www/html/...App/Modules/Products/....Controller.php 
    // to App\Modules\Product\....Controller
    private static function convertControllerPathToNamespace(string $file): string
    {
        ...
        $relative = str_replace(AppConfig::getConst('LOCAL_PATH_APP_MODULES'), '', $normalized);
        $relative = str_replace('.php', '', $relative);
        $classPath = 'App\\Modules\\' . str_replace('/', '\\', ltrim($relative, '/'));
    ...
    private static function getRoutesFromClass(string $class): array
    {
        ...
        // ROUTE MODULE: 
        // Ex: 'App\Modules\Product\...' => 'Product'
    ...
    {
        // 'Product' <= 'App\Modules\Product\Interface\Http\Controllers\...'
